...
Page({
  ...
  ViewImage() {
    if (this.data.showData.avatar == null) {
      wx.previewImage({
        urls: [
          "https://img-blog.csdnimg.cn/8e7018841dc04c62b3e6bc2c8882a45b.png",
        ],
        current:
          "https://img-blog.csdnimg.cn/8e7018841dc04c62b3e6bc2c8882a45b.png",
      });
  ...
  showForm(e) {
    this.setData({
      "postData.title":
        this.data.AllMessageList[e.currentTarget.dataset.index].title,
      "postData.text":
        this.data.AllMessageList[e.currentTarget.dataset.index].text,
      modalName: "Messages",
      title: "群组消息查看",
    });
  },
